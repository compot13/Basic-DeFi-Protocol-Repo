...
/*
 * @title DSCEngine
 * @author NickV (github nickname compot13)
 *
...
contract DSCEngine is ReentrancyGuard {
    ...
    event CollateralRedeemed(
        address indexed redeemedFrom, address indexed rredeemedTo, address indexed token, uint256 amount
    );
    ...
    * @notice: A known bug would be if the protocol was only 100% collateralized, we wouldn't be able to liquidate
    ...
    //////////
    /*
    //*dev@ Low-lever internal function, do not call unless the function calling it is checking for health factor being
    broken
    */
